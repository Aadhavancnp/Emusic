...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        faqs = [
            ...
            {
                'question': 'Can I use E-Music offline?',
                'answer': 'Currently, E-Music requires an internet connection to stream music and access your playlists. We\'re working on an offline mode for premium users, which will be available in a future update.'
            },
            {
            ...
            {
                'question': 'What audio quality does E-Music offer?',
                'answer': 'E-Music offers streaming quality up to 320kbps for premium users. Free users can enjoy music at 128kbps. The actual quality may vary depending on your internet connection and device capabilities.'
            },
            {
